...
def mock_domain_classifier_dependencies(monkeypatch):
    ...
    monkeypatch.setattr("second_opinion.utils.domain_classifier.create_client_from_config", create_mock_client)
    
    # Mock provider detection
    def mock_detect_provider(model):
        return "openrouter"
    
    monkeypatch.setattr("second_opinion.utils.domain_classifier.detect_model_provider", mock_detect_provider)
...
class TestDomainClassifier:
    ...
    @pytest.mark.asyncio
    async def test_classification_with_context(self, mock_domain_classifier_dependencies):
    ...
    @pytest.mark.asyncio
    async def test_confidence_threshold_fallback(self, mock_domain_classifier_dependencies):
    ...
    @pytest.mark.asyncio
    async def test_high_confidence_classification(self, mock_domain_classifier_dependencies):
...
class TestUtilityFunctions:
    ...
    @pytest.mark.asyncio
    async def test_classify_consultation_domain_convenience(self, mock_domain_classifier_dependencies):
...
async def test_integration_classification_workflow(mock_domain_classifier_dependencies):
    ...
    test_cases = [
        ...
        ("Optimize database", '{"domain": "performance", "confidence": 0.88}', "performance"),
