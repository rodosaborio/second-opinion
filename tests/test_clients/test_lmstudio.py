...
class TestLMStudioClient:
    ...
    @pytest.mark.asyncio
    async def test_get_available_models_caches_results(self, client, mock_models_response):
    ...
    @pytest.mark.asyncio
    async def test_parse_response_success(self, client, sample_request, mock_completion_response):
    ...
    @pytest.mark.asyncio
    async def test_complete_success(self, client, sample_request, mock_completion_response):
    ...
    async def test_get_loaded_model_client_error(self, client):
        ...
        with patch.object(client, 'get_available_models', side_effect=ClientError("Connection failed", "lmstudio")):
            loaded_model = await client.get_loaded_model()
            assert loaded_model is None
