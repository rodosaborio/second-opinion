...
class ModelPricingInfo(BaseModel):
    ...
    mode: Optional[str] = Field(None, description="Model mode (chat, embedding, etc.)")
    supports_function_calling: Optional[bool] = Field(None, description="Function calling support")
...
class PricingManager:
    ...
    def __init__(
        ...
        # Thread-safe cache
        self._cache: Optional[PricingCache] = None
    ...
    def get_model_pricing(self, model_name: str) -> Optional[ModelPricingInfo]:
        """
...
_global_pricing_manager: Optional[PricingManager] = None
...
def set_pricing_manager(manager: Optional[PricingManager]) -> None:
...
def get_model_pricing_info(model_name: str) -> Optional[ModelPricingInfo]:
