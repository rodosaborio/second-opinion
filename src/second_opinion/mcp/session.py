...
class MCPSession:
    ...
    def __init__(self, session_id: str | None = None):
        ...
        self.pricing_cache: Dict[str, tuple[Decimal, Decimal]] = {}  # model -> (input_cost, output_cost)
    ...
    def record_cost(self, tool_name: str, cost: Decimal, model: str) -> None:
        ...
        logger.debug(f"Session {self.session_id}: Recorded ${cost} for {tool_name} using {model}")
    ...
    def add_conversation_context(
        ...
        logger.debug(f"Session {self.session_id}: Added conversation context for {tool_name}")
