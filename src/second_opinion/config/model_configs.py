...
class ToolConfig(BaseModel):
    ...
    comparison_models: list[str] | None = Field(None, description="Models to use for comparison")
    upgrade_targets: dict[str, str] | None = Field(None, description="Upgrade target models")
    downgrade_targets: list[str] | None = Field(None, description="Downgrade target models")
    ...
    system_prompt_template: str | None = Field(None, description="System prompt template name")
...
class ModelCapabilities(BaseModel):
    ...
    cost_per_input_token: Decimal | None = Field(None, ge=0, description="Cost per input token")
    cost_per_output_token: Decimal | None = Field(None, ge=0, description="Cost per output token")
...
class ModelProfilesConfig(BaseModel):
    ...
    def get_upgrade_target(self, current_model: str, upgrade_type: str = "any_to_reasoning") -> str | None:
...
class ModelConfigManager:
    ...
    def get_model_config(self, tool_name: str, primary_model: str | None = None) -> dict[str, Any]:
        """
...
def get_model_config(tool_name: str, primary_model: str | None = None) -> dict[str, Any]:
